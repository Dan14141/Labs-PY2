...
class Book:
    ...
    def __init__(self, id_, name, pages):
        ...
        self.id = id_ # Ид книги
        self.name = name # Название книги
        self.pages = pages # Колво страниц
    ...
    # Метод для представления объекта класса Book в строку
    def __repr__(self):
...
class Library:
    ...
    def get_next_book_id(self):
        ...
        # Возвращение ид для добавления книги
        return max(book.id for book in self.books) + 1

    # Метод получения индекса книги
